...
Parameters:
"
    echo "--apache_option [1-4], please select a Web server version like below"
...
process(){
    ...
    while [ ${#} -gt 0 ]; do
        ...
        --apache_option)
            ...
            [[ "${apache_option}" -lt 1 || "${apache_option}" -gt 4 ]] && _error "apache_option input error, please only input a number between 1 to 4"
