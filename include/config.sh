...
#mariadb10.1
mariadb10_1_filename="mariadb-10.1.38"
#mariadb10.2
...
#percona5.6
percona5_6_filename="Percona-Server-5.6.43-84.3"
#percona5.7
percona5_7_filename="Percona-Server-5.7.25-28"
#percona8.0
...
#swoole
swoole_filename="swoole-src-4.3.3"
swoole_filename_url="https://github.com/swoole/swoole-src/archive/v4.3.3.tar.gz"
set_hint ${swoole_filename} "php-swoole-4.3.3"
#yaf
