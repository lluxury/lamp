...
tengine_location=/usr/local/nginx
...
#nginx1.8
nginx_1_11_filename="nginx-1.11.4"
nginx_1_11_filename_url="http://nginx.org/download/nginx-1.11.4.tar.gz"
#tengine2.2
...
#mariadb10.1
mariadb10_1_filename="mariadb-10.1.43"
#mariadb10.2
mariadb10_2_filename="mariadb-10.2.29"
#mariadb10.3
mariadb10_3_filename="mariadb-10.3.20"
#mariadb10.4
mariadb10_4_filename="mariadb-10.4.10"
#percona5.5
...
#php7.2
php7_2_filename="php-7.2.25"
php7_2_filename_url="https://www.php.net/distributions/php-7.2.25.tar.gz"
#php7.3
